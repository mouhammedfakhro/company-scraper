...
export function useCheckCompany<TError = DefaultError>(args: { operation: PolicyCrudKind; where?: { id?: string; organizationNumber?: string; name?: string; State?: string; address?: string; postalCode?: string; city?: string; registeredDate?: string; description?: string; url?: string; CEO?: string; SNI?: string; isFavorite?: boolean; scraperId?: string }; }, options?: (Omit<UseQueryOptions<boolean, TError, boolean>, 'queryKey'> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
